...
(function (i) {
    ...
    var p = i.Axis, q = i.Chart, x = i.Color, t = i.Point, G = i.Pointer, D = i.Legend, H = i.LegendSymbolMixin,
        Q = i.Renderer, y = i.Series, I = i.SVGRenderer, M = i.VMLRenderer, B = i.win, N = B.document, J = i.addEvent,
        k = i.each, E = i.error, o = i.extend, u = i.extendClass, n = i.merge, l = i.pick, z = i.getOptions(),
        m = i.seriesTypes, w = z.plotOptions, v = i.wrap, s = function () {
        };
    v(p.prototype, "getSeriesExtremes", function (a) {
        ...
        a.call(this);
        if (b &&
            (c = l(this.dataMin, Number.MAX_VALUE), d = l(this.dataMax, -Number.MAX_VALUE), k(this.series, function (a, b) {
                if (a.useMapGeometry) c = Math.min(c, l(a.minX, c)), d = Math.max(d, l(a.maxX, c)), a.xData = e[b], f = !0
    ...
    v(p.prototype, "setAxisTranslation", function (a) {
        ...
        a.call(this);
        this.coll === "yAxis" && b.transA !== void 0 && k(this.series, function (a) {
    ...
    o(C.prototype, {
        defaultColorAxisOptions: {
            ...
            var c = a.padding, d = a.options, e = this.horiz, f = l(d.symbolWidth, e ? 200 : 12),
                g = l(d.symbolHeight, e ? 12 : 200), h = l(d.labelPadding, e ? 16 : 30), d = l(d.itemDistance, 10);
            this.setLegendColor();
        ...
        }, setState: s, visible: !0, setVisible: s,
        getSeriesExtremes: function () {
            ...
            if (a.dataClasses && d.allItems) k(d.allItems, function (a) {
                a.isDataClass && a.legendGroup.destroy()
            }), c.isDirtyLegend = !0;
            c.options[this.coll] = n(this.userOptions, a);
            p.prototype.update.call(this, a, b);
            this.legendItem && (this.setLegendColor(), d.colorizeItem(this,
                !0))
        }, getDataClassLegendSymbols: function () {
            var a = this, b = this.chart, c = this.legendItems, d = b.options.legend, e = d.valueDecimals,
                f = d.valueSuffix || "", g;
            c.length || k(this.dataClasses, function (d, j) {
                var r = !0, A = d.from, l = d.to;
                g = "";
                A === void 0 ? g = "< " : l === void 0 && (g = "> ");
                A !== void 0 && (g += i.numberFormat(A, e) + f);
                A !== void 0 && l !== void 0 && (g += " - ");
    ...
    o(q.prototype, {
        renderMapNavigation: function () {
            ...
            if (l(b.enableButtons, b.enabled) && !a.renderer.forExport) for (d in c) if (c.hasOwnProperty(d)) f = n(b.buttonOptions, c[d]), e = f.theme, e.style = n(f.theme.style, f.style), g = e.states, e = a.renderer.button(f.text, 0, 0, j, e, g && g.hover, g && g.select, 0, d === "zoomIn" ? "topbutton" : "bottombutton").attr({
                width: f.width,
                height: f.height,
                ...
                width: e.width,
                height: 2 * e.height
            }), null, f.alignTo), J(e.element, "dblclick", h)
        },
        fitToBox: function (a, b) {
            k([["x", "width"], ["y", "height"]], function (c) {
                var d = c[0], c = c[1];
            ...
            var f = this.xAxis[0], g = f.max - f.min, h = l(b, f.min + g / 2), j = g * a, g = this.yAxis[0],
                i = g.max - g.min, A = l(c, g.min + i / 2);
            i *= a;
            h = this.fitToBox({
    ...
    v(q.prototype, "render", function (a) {
        ...
        a.call(b);
        (l(c.enableDoubleClickZoom, c.enabled) || c.enableDoubleClickZoomTo) && J(b.container, "dblclick", function (a) {
            b.pointer.onContainerDblClick(a)
        });
        l(c.enableMouseWheelZoom,
            c.enabled) && J(b.container, N.onmousewheel === void 0 ? "DOMMouseScroll" : "mousewheel", function (a) {
    ...
    o(G.prototype, {
        onContainerDblClick: function (a) {
            ...
            var b =
                this.chart, c, a = this.normalize(a);
    ...
    v(G.prototype, "init", function (a, b, c) {
        a.call(this, b, c);
    ...
    v(G.prototype, "pinchTranslate", function (a, b, c, d, e, f, g) {
    ...
    var P = u(t, o({
        applyOptions: function (a, b) {
            ...
            var a = this, b = +new Date,
                c = x(a.color),
                d = x(a.pointAttr.hover.fill), e = a.series.options.states.normal.animation,
    ...
    m.map = u(m.scatter, n(O, {
        ...
        getBox: function (a) {
            var b = Number.MAX_VALUE, c = -b, d = b, e = -b, f = b, g = b, h = this.xAxis, j = this.yAxis, r;
            k(a || [], function (a) {
                if (a.path) {
                    if (typeof a.path === "string") a.path = i.splitPath(a.path);
                    var h = a.path || [], j = h.length,
                        k = !1, m = -b, n = b, o = -b, p = b, q = a.properties;
                    if (!a._foundBox) {
        ...
        translatePath: function (a) {
            var b = !1, c = this.xAxis, d = this.yAxis, e = c.min, f = c.transA, c = c.minPixelPadding, g = d.min,
                h = d.transA, d = d.minPixelPadding, j, i = [];
            if (a) for (j = a.length; j--;) typeof a[j] === "number" ? (i[j] = b ? (a[j] - e) * f + c : (a[j] - g) * h + d, b = !b) : i[j] = a[j];
            return i
        },
        setData: function (a, b) {
            var c = this.options, d = c.mapData, e = c.joinBy, f = e === null, g = [], h, j, l;
            f && (e = "_i");
            ...
            if (d) {
                if (d.type === "FeatureCollection") {
                    if (d["hc-transform"]) for (h in this.chart.mapTransforms = j = d["hc-transform"], j) if (j.hasOwnProperty(h) && h.rotation) h.cosAngle = Math.cos(h.rotation), h.sinAngle = Math.sin(h.rotation);
                    d = i.geojson(d, this.type, this)
                }
                this.getBox(d);
                this.mapData = d;
                this.mapMap = {};
                for (l = 0; l < d.length; l++) h = d[l], j = h.properties, h._i = l, e[0] && j && j[e[0]] && (h[e[0]] = j[e[0]]), this.mapMap[h[e[0]]] =
                    h;
                c.allAreas && (a = a || [], e[1] && k(a, function (a) {
                    g.push(a[e[1]])
                }), g = "|" + g.join("|") + "|", k(d, function (b) {
        ...
        translate: function () {
            ...
            k(a.data, function (e) {
                ...
                if (d) e.shapeType = "path", e.shapeArgs = {d: a.translatePath(e.path)}, F && (e.shapeArgs["vector-effect"] = "non-scaling-stroke")
            });
            a.translateColors()
        },
        drawPoints: function () {
            ...
            a.doFullTranslate() ? (e.hasRendered && a.pointAttrToOptions.fill === "color" && k(a.points, function (a) {
                if (a.shapeArgs) a.shapeArgs.fill =
                    a.pointAttr[l(a.state, "")].fill
            }), F || k(a.points, function (b) {
                b = b.pointAttr[""];
                b["stroke-width"] === a.pointAttr[""]["stroke-width"] && (b["stroke-width"] = "inherit")
            }), a.group = a.transformGroup, m.column.prototype.drawPoints.apply(a), a.group = d, k(a.points, function (a) {
            ...
            F || a.group.element.setAttribute("stroke-width",
                a.options.borderWidth / (g || 1));
        ...
        pointClass: u(t,
            {
                applyOptions: function (a, b) {
                    var c;
                    a && a.lat !== void 0 && a.lon !== void 0 ? (c = t.prototype.applyOptions.call(this, a, b), c = o(c, this.series.chart.fromLatLonToPoint(c))) : c = P.prototype.applyOptions.call(this, a, b);
                    return c
                }, ttBelow: !1
            }),
        xyFromShape: !0,
    ...
    m.heatmap = u(m.scatter, n(O, {
        ...
        translate: function () {
            ...
            k(this.points, function (e) {
                var f = (a.colsize || 1) / 2, g = (a.rowsize || 1) / 2,
                ...
                e.plotY = (j + g) / 2;
                e.shapeType = "rect";
                e.shapeArgs = {x: Math.min(h, f), y: Math.min(j, g), width: Math.abs(f - h), height: Math.abs(g - j)}
            });
    ...
    q.prototype.transformFromLatLon = function (a, b) {
        if (B.proj4 === void 0) return E(21), {x: 0, y: null};
        var c = B.proj4(b.crs, [a.lon, a.lat]), d = b.cosAngle || b.rotation && Math.cos(b.rotation),
    ...
    q.prototype.transformToLatLon = function (a, b) {
        if (B.proj4 ===
            ...
            var c = {
                ...
                e = b.sinAngle || b.rotation && Math.sin(b.rotation),
                c = B.proj4(b.crs, "WGS84", b.rotation ? {x: c.x * d + c.y * -e, y: c.x * e + c.y * d} : c);
    ...
    i.geojson = function (a, b, c) {
        ...
        k(a.features, function (a) {
            var c = a.geometry, j = c.type, c = c.coordinates, a = a.properties, i;
            e = [];
            b === "map" || b === "mapbubble" ? (j === "Polygon" ? (k(c, f), e.push("Z")) : j === "MultiPolygon" && (k(c, function (a) {
                k(a, f)
            }), e.push("Z")), e.length && (i = {path: e})) : b === "mapline" ? (j === "LineString" ? f(c) : j === "MultiLineString" && k(c, f), e.length && (i = {path: e})) : b === "mappoint" && j === "Point" && (i = {
                x: c[0],
                y: -c[1]
            });
            i && d.push(o(i, {name: a.name || a.NAME, properties: a}))
        });
    ...
    v(q.prototype, "showCredits", function (a, b) {
    ...
    Q === M && k(["topbutton", "bottombutton"], function (a) {
